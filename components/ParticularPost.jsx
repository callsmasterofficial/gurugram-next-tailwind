      ...
      <div className="m-auto p-2">
        <div className="border-2 p-4">
          ...
          <div className="xl:flex p-2">
            ...
            {/* Comments and Views */}
            <div className="flex md:ml-auto  items-center text-center">
          ...
          <div className="socialSharing hidden md:block md:my-2 p-2">
            <SocialSharing />
          </div>
          ...
          <div className="main_Content p-2">
            ...
            <div className="mt-4">
              <p>
                ...
                ये सेल आज यानी 14 जुलाई से शुरू हुई है, जो 17 जुलाई तक चलने वाली
                है। इस सेल में इलेक्ट्रॉनिक प्रोडक्ट्स जैसे की स्मार्टफोन्स,
                स्मार्ट टीवी और कई अन्य इलेक्ट्रॉनिक प्रोडक्ट्स पर बम्पर
                डिस्काउंट मिल रहा है। महंगे से महंगे स्मार्टफोन्स इस सेल में
                काफी सस्ते में मिल रहे है और अगर आप एक iPhone फैन हैं, तो आपके
                लिए यह खबर काफी काम की हो सकती है। इस सेल में iPhone 12 पर अब तक
                का सबसे बड़ा डिस्काउंट मिल रहा है। आइए आपको बताते हैं की सेल में
                आपको iPhone 12 कितने का मिलेगा :- <br />
                <br />
                Phone 12 (64GB) की लॉन्चिंग प्राइज 65,900 रुपये है लेकिन
                Flipkart पर ये 51,999 रुपये में उपलब्ध है जिसका मतलब फोन पर
                13,901 रुपये की छूट मिल रही है और फोन पर कई बैंक और एक्सचेंज ऑफर
                भी है, जिससे इसकी कीमत काफी कम हो जाएगी। <br />
                <br />
                अगर iPhone 12 को खरीदने के लिए आप SBI बैंक के credit card
                (क्रेडिट कार्ड) का इस्तेमाल करते हैं तो आपको 750 रुपये का
                डिस्काउंट मिलेगा जिससे फ़ोन की कीमत 51,999 से घटकर 51,249 रुपये
                हो जाएगी। <br />
                <br />
                iPhone 12 पर एक्सचेंज ऑफर भी मिल रहा है जो की 12,500 रुपये का है
                यानी की अगर आप अपना पुराना स्मार्टफोन एक्सचेंज करते हैं तो इतना
                ऑफ (12,500) आपको मिल सकता है लेकिन ऑफ तभी मिलेगा जब आपके पुराने
                फोन की कंडीशन अच्छी हो और मॉडल लेटेस्ट हो और अगर आप पूरा
                एक्सचेंज ऑफर पाने में कामयाब रहे तो फोन की कीमत 38,749 रुपये हो
                जाएगी यानी की सारे ऑफर मिलाकर आपको iPhone 12 पर 27 हजार रुपये की
                छूट मिल रही है।
              </p>
            </div>
          </div>
          ...
          {/* Social Icons for Sharing... */}
          <div className="socialSharing hidden md:flex md:text-center md:items-center border-t-2 p-2 py-6 bg-gray-50">
            <ShareIcon />
