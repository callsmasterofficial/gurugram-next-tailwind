              ...
              return (
                <div key={data.id} className=" mb-4">
                  <div className="grid  md:grid-cols-2">
                    ...
                    >
                      <img
                        className="object-cover w-[100%] h-[100%] lg:h-56 mx-auto sm:mx-auto hover:scale-110  transition-all duration-300 ease-linear"
                        src={data.image}
                        alt="imge not found"
                      />
                    </div>
                    <div className="p-3 col-span-1 ">
                      ...
                      <h2 className="font-extrabold hover:text-blue-500 mt-1 mb-1">
                        {data.title}
                      </h2>
                      <p className="text-base mt-1 mb-1">{data.description}</p>
